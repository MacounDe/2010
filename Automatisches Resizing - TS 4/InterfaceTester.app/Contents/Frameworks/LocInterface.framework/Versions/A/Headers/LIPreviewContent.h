...
/*!
 ...
 @discussion Must be set before loading the preview using -load. Should not be changed afterwards.
 */
@property(retain) id <BLDocumentProtocol> document;
...
/*!
 @abstract Returns a view options to be presented to the user (if any).
 @discussion This is a "static" property of the content, i.e., it will not change after the preview has been loaded at first sight. The options view will be displayed in a drawer of the preview window.
 */
- (NSView *)optionsView;

/*!
 @abstract Returns a custom view for showing a highlight.
 @discussion When this (KVO-observable) property is not nil, a view showing some highlight in the current preview. It replaces the default view that outlines the focussed key objects. It will be displayed in a separate window above the preview window and will thus receive all user events directly. The view will be centered around the root view, and thus allows display even out of the view's bounds.
 */
- (NSView *)overlayView;
 ...
 */
@property(retain) BLKeyObject *focussedKeyObject;
...
/*!
 @abstract A user-presentable status information. Can be used to explain some problems, etc.
 */
@property(retain) NSString *statusInfo;
