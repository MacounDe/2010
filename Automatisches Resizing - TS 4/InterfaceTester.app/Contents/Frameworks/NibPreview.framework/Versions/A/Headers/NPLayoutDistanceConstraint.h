...
/*!
 @abstract Object restricting the distance between two tab stops.
 ...
 */
@interface NPLayoutDistanceConstraint : NPLayoutConstraint <BLPropertyListSerialization>
{
	...
	NSArray			*_maxStopName;
	NSArray			*_minStopName;
}
